...
import { toggleLikeWish, togglePocketWish } from "../../actions/wishActions";
...
class WishItem extends Component {
  ...
  onLikeClick = (id) => {
    this.props.toggleLikeWish(id);
  };

  onPocketClick = (id) => {
    this.props.togglePocketWish(id);
  };
      ...
      <div className={classes.wish_card}>
        ...
        <div className={classes.wish_card_footer}>
          ...
          <div className={classes.card_comment}>
            <p className={classes.card_comment_icon}>
...
export default connect(mapStateToProps, { toggleLikeWish, togglePocketWish })(
  withRouter(WishItem)
);
